...
\begin{center}
    ...
    \href{mailto:contact@jayeshvp24.dev}{\raisebox{-0.2\height}\faEnvelope\  \underline{contact@jayeshvp24.dev}} ~ 
...
\section{EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Self Employed \href{certificate Link}{\raisebox{-0.1\height}}}{JAN 2022 -- present} 
      {\underline{Freelance Full Stack Web Developer}}{Mumbai, India}
      \resumeItemListStart
        \resumeItem{\normalsize{Helped \textbf{20+ businesses} build their \textbf{online presence} and \textbf{increase revenue} }}
        \resumeItem{\normalsize{Catered to variety of industries including blockchain, food, education, etc by building them \textbf{exceptional frontend's} }}
      \resumeItemListEnd
    \resumeSubheading
      {TCET - Open Source \href{https://opensource.tcetmumbai.in/}{\raisebox{-0.1\height}\faExternalLink
      }
      \href{https://github.com/tcet-opensource/}{\raisebox{-0.1\height}\faGithub}}{MAR 2023 -- AUG 2023} 
      ...
      \resumeItemListStart
        ...
        \resumeItem{\normalsize{Built \textbf{10+ Projects} using technologies such as React, Astro, Strapi, Next.js Github Pages}}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\normalsize{Catered to \textbf{5+ clients} website needs }}
         ...
         \resumeItem{\normalsize{Increased \textbf{Page Load Speed by 60\%} using \textbf{Image Optimization}
}}
      \resumeItemListEnd
  \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\normalsize{\textbf{Wrote 30+ APIs} in Node.js, Express, TypeORM, MySQL, MongoDB, Redis, Postman related to transactions, dashboard, visualization}}
         ...
         \resumeItem{\normalsize{ Increased API \textbf{response speeds by 40\%} by \textbf{optimizing edge cases} }}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
\vspace{-12pt}
...
\section{PROJECTS}
    ...
    \resumeSubHeadingListStart
       \resumeProjectHeading
          {\href{https://retronexus.world/}{\textbf{\large{\underline{Retro
          Nexus}}}
          \href{https://retronexus.world/}{\raisebox{-0.1\height}\faExternalLink
          }} $|$ \large{\underline{SvelteKit, GPT, Hugging Face, Solana, XState,
          TailwindCSS}}}{OCT 2023}
          \resumeItemListStart
            \resumeItem{\normalsize{AI powered multi-storyline game rewarding NFTs}}
            \resumeItem{\normalsize{\textbf{Live} and \textbf{70+ stories} being played every week }}
          \resumeItemListEnd 
          \vspace{-13pt}

       \resumeProjectHeading
          {\href{https://activitydekho.com/}{\textbf{\large{\underline{Activity Dekho}}} \href{https://activitydekho.com/}{\raisebox{-0.1\height}\faExternalLink }} $|$ \large{\underline{Next.js, Firebase, Google Cloud, XState, TailwindCSS}}}{DEC 2022}
          \resumeItemListStart
...
\section{TECHNICAL SKILLS}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{\normalsize{Languages:}}{ \normalsize{Javascript, Typescript}} \\
     \textbf{\normalsize{Databases:}}{ \normalsize{MySQL, Firestore, MongoDB, PostgresSQL, Redis}} \\
     \textbf{\normalsize{Tools:}}{ \normalsize{Neovim, Linux, Figma, Postman, Git, Notion, Github, Discord}} \\
     \textbf{\normalsize{Technologies/Frameworks:}}{
       \normalsize{React.js, Svelte, Sveletkit, Next.js,  Astro, Vite, tRPC, Solana, Node.js, Express, Shadcn UI, TailwindCSS, HTML, CSS, Redux, Jotai, Firebase, X-state, UI/UX, Google Cloud Platform}} \\
