  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\normalsize{Catered to variety of industries including blockchain, food, education. }}
      \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\normalsize{Built \textft{10+ Projects} using technologies such as React, Astro, Strapi, Next.js Github Pages}}
...
\section{TECHNICAL SKILLS}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{\normalsize{Tools:}}{ \normalsize{Neovim, Figma, Postman, Git, Notion, Github, Discord}} \\
     \textbf{\normalsize{Technologies/Frameworks:}}{
       \normalsize{Svelte, Sveletkit, Vite, React.js, Next.js, Astro, tRPC, Solana, Node.js, Express, TailwindCSS, Sass, HTML, CSS, Redux, Firebase, X-state, UI/UX, Google Cloud Platform}} \\
...
\section{EDUCATION}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.TECH IN AI\&ML - \textbf{CGPA} - \textbf{9.2} average of 7 terms}{Mumbai, India}
  \resumeSubHeadingListEnd
  \resumeSubHeadingListStart
    \resumeSubheading
